      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          <div className="mb-8">
            ...
            <p className="text-sm text-white/50 mt-1">New accounts are created as client accounts.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <p className="text-center text-xs text-white/30">
              ...
              <a href="/client/login" className="text-purple-400 hover:text-purple-300 transition-colors">
                Sign in
              </a>
            </p>
          </form>
