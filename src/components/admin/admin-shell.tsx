...
const navItems = [
  ...
  { label: 'Chat', href: '/admin/chat', icon: <MessageSquare size={18} /> },
  { label: 'Documents', href: '/admin/documents', icon: <FileText size={18} /> },
  { label: 'Change Requests', href: '/admin/change-requests', icon: <GitPullRequest size={18} /> },
  { label: 'Milestones', href: '/admin/milestones', icon: <Milestone size={18} /> },
